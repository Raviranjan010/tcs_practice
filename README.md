# 🚀 TCS NQT Complete Preparation Repository (Ninja, Digital & Prime)
...
| :--- | :--- | :--- |
| 📍 [60-Day Prep Roadmap](ROADMAP.md) | Day-by-day study schedule for 60 days | Structured Strategy |
| 📋 [Exam Pattern & Cutoffs](EXAM_PATTERN.md) | 2024-25 Latest Exam Pattern, Marking & Rounds | Exam Strategy |
| 🔢 [01. Numerical Ability](01_Numerical_Ability/README.md) | 12 Topics from Number System to Logarithms + Cheat Sheet | Foundation Math |
...
## 🎯 Target Categories & Packages

TCS recruits for three distinct packages based on your NQT performance:
...
1. **Check the Pattern**: Start with [EXAM_PATTERN.md](EXAM_PATTERN.md) to understand what you are up against.
2. **Follow the Schedule**: Open [ROADMAP.md](ROADMAP.md) and commit to the daily prep plan.
3. **Learn Topic-Wise**: Go through the folders sequentially. For each topic:
