 ...
 *
 * PROBLEM STATEMENT:
 * Write an efficient C++ program to solve Inverted Right Triangle matching all constraints.
 *
 * EXAMPLE:
...
int main() {
    ...
    cout << "Test driver completed successfully for Inverted Right Triangle!" << endl;
    return 0;
}
