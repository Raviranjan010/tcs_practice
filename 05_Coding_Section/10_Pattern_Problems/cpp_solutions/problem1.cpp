 ...
 *
 * PROBLEM STATEMENT:
 * Write an efficient C++ program to solve Right Triangle Stars matching all constraints.
 *
 * EXAMPLE:
...
int main() {
    ...
    cout << "Test driver completed successfully for Right Triangle Stars!" << endl;
    return 0;
}
