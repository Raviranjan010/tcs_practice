 ...
 *
 * PROBLEM STATEMENT:
 * Write an efficient C++ program to solve Kth Largest Element matching all constraints.
 *
 * EXAMPLE:
...
int main() {
    ...
    cout << "Test driver completed successfully for Kth Largest Element!" << endl;
    return 0;
}
