 ...
 *
 * PROBLEM STATEMENT:
 * Write an efficient C++ program to solve Longest Common Prefix matching all constraints.
 *
 * EXAMPLE:
 ...
 * Optimal:     Optimal STL or Two Pointers - Time: O(N*M), Space: O(1)
 */
...
int main() {
    ...
    cout << "Test driver completed successfully for Longest Common Prefix!" << endl;
    return 0;
}
