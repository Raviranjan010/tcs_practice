 ...
 *
 * PROBLEM STATEMENT:
 * Write an efficient C++ program to solve Search in Sorted Matrix matching all constraints.
 *
 * EXAMPLE:
...
int main() {
    ...
    cout << "Test driver completed successfully for Search in Sorted Matrix!" << endl;
    return 0;
}
