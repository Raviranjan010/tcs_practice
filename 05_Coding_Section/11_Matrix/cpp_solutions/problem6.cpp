/*
 * PROBLEM: Count Islands
 * CATEGORY: Digital
 * DIFFICULTY: Medium
 * TOPIC: Matrix
 *
 * PROBLEM STATEMENT:
 * Write an efficient C++ program to solve Count Islands matching all constraints.
 *
 * EXAMPLE:
...
int main() {
    ...
    cout << "Test driver completed successfully for Count Islands!" << endl;
    return 0;
}
