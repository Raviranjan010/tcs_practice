/*
 * PROBLEM: Armstrong & Perfect Number
 * CATEGORY: Ninja
 * DIFFICULTY: Medium
 * TOPIC: Math & Number Theory
 *
 * PROBLEM STATEMENT:
 * Write an efficient C++ program to solve Armstrong & Perfect Number matching all constraints.
 *
 * EXAMPLE:
...
int main() {
    ...
    cout << "Test driver completed successfully for Armstrong & Perfect Number!" << endl;
    return 0;
}
