/*
 * PROBLEM: Count Prime Factors
 * CATEGORY: Digital
 * DIFFICULTY: Medium
 * TOPIC: Math & Number Theory
 *
 * PROBLEM STATEMENT:
 * Write an efficient C++ program to solve Count Prime Factors matching all constraints.
 *
 * EXAMPLE:
...
// ─── OPTIMAL SOLUTION ────────────────────────────────────
// Time: O(N), Space: O(1)
int primeFactors(int n) { return 0; }
...
int main() {
    ...
    cout << "Test driver completed successfully for Count Prime Factors!" << endl;
    return 0;
}
